...
export class CSG {
    ...
    static eval(tokens: Mesh, doRemove: boolean) { // [['add',mesh,mesh,mesh,mesh],['sub',mesh,mesh,mesh,mesh]]
        CSG.currentOp = null;
        CSG.sourceMesh = null;
...
class Plane {
    ...
    splitPolygon(polygon: Polygon, coplanarFront: Polygon[], coplanarBack: Polygon[],
